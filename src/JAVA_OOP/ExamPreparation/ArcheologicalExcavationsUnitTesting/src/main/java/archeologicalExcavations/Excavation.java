...
public class Excavation {
    ...
    private String name;
    private final Collection<Archaeologist> archaeologists;
    ...
    public void addArchaeologist(Archaeologist archaeologist) {
        ...
        if (archaeologistExist) {
            throw new IllegalArgumentException(String.format(ARCHAEOLOGIST_EXIST));
        }
    ...
    public boolean removeArchaeologist(String archeologistName) {
        ...
        return this.archaeologists.remove(archaeologist);
    }
